            ...
            {(provided, snapshot) => {
              ...
              return (
                <div
                  className={
                    isSingleDay
                      ? `mx-auto min-h-[120px] w-full max-w-2xl rounded-xl bg-white p-4 shadow transition ${
                          isDraggingOver ? 'ring-2 ring-indigo-400' : ''
                        }`
                      : `min-h-[120px] min-w-[250px] max-w-full flex-1 rounded-xl bg-white p-4 shadow transition ${
                          isDraggingOver ? 'ring-2 ring-indigo-400' : ''
                        }`
                  }
                >
                        ...
                        >
                          {(provided, snapshot) => (
                            <div
                              ...
                              className={`mb-3 flex cursor-pointer items-center justify-between rounded bg-indigo-50 p-3 shadow-sm ${
                                snapshot.isDragging
                                  ? 'ring-2 ring-indigo-300'
                                  : ''
                              }`}
                              onClick={() =>
                                onEditEvent && onEditEvent(day, idx)
                              }
                            >
                              <div>
